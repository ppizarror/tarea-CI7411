function ft = fa_velt_sa(rho, Vs, D, H, E1)
%FT_VELT Calcula factor de amplificacion caso viscoelastico entre la
%superficie y la superficie del afloramiento rocoso.
%
% Parametros:
